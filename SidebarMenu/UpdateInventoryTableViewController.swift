//
//  UpdateInventoryTableViewController.swift
//  Bar Analytic
//
//  Created by Ritesh Arora on 5/12/16.
...
class UpdateInventoryTableViewController: UITableViewController, UISearchBarDelegate, NSURLSessionDelegate {
